...
const products = [
  ...
  { id: 6, name: 'Power Bank', price: 39.99, rating: 4.4, image: 'https://images.unsplash.com/photo-1544866092-1935c5ef2a8f?ixlib=rb-1.2.1&auto=format&fit=crop&w=300&q=80', category: 'Accessories' },
