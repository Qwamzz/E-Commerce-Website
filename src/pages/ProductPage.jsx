...
const products = [
  ...
  { id: 8, name: 'Security Camera', price: 129.99, rating: 4.5, image: 'https://tinyurl.com/38xhpn9e', description: 'Smart security camera with advanced features.', features: ['1080p HD video', 'Night vision', 'Motion detection', 'Two-way audio'] },
  { id: 9, name: 'Smart Band', price: 89.99, rating: 4.4, image: 'https://tinyurl.com/4wax5dnf', description: 'Fitness tracking smart band with health monitoring.', features: ['Heart rate monitor', 'Sleep tracking', 'Water resistant', 'OLED display'] },
  { id: 10, name: 'External SSD', price: 119.99, rating: 4.7, image: 'https://tinyurl.com/2ya5z896', description: 'Fast and portable external SSD storage.', features: ['1TB capacity', 'USB-C interface', 'Shock resistant', '540MB/s speed'] }
];
